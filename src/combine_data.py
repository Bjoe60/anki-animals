...
def combine_data():
    ...
    df_merged = reduce(lambda left,right: pd.merge(left,right, on='eolID', how='left'), [df_species, df_translations, df_countries, df_images])
