...
def get_preferred_only(df_translations):
    ...
    df_translations = df_translations.merge(preferred_groups.drop_duplicates(), on='page_id', how='left', indicator='preferred_exists')
...
def get_translations():
    ...
    output_path = os.path.join('data', 'species with translations.csv')
